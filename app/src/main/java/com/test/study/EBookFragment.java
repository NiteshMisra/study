...
public class EBookFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        rcv = view.findViewById(R.id.eBook_rcv);
        rcv.setHasFixedSize(true);
        noInternet = view.findViewById(R.id.ebookNoInternet);
        noData = view.findViewById(R.id.ebookNoData);
        rcv.setLayoutManager(new LinearLayoutManager(this.getActivity()));
        eBookRefresh = view.findViewById(R.id.ebookRefresh);
        loadLayout();
